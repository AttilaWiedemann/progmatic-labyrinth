...
public class WallFollowerPlayer implements Player {
    ...
    private String preferedDirection;
    ...
    public Direction nextMove(Labyrinth l) {
        ...
        if(roundCounter == 1){
            ...
            if(possibleMoves.contains(myWay)){
                return myWay;   //doesen't turn until reaches a wall in front
            }else if(myWay.equals(Direction.NORTH)){
                if(preferedDirection.equals("right")){
                    if(possibleMoves.contains(Direction.EAST)){ //If there is a crossing an can turn right
